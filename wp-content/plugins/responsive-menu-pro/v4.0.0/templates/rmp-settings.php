...
$font_display_property = 'auto';
if ( ! empty( $global_settings['font_display_property'] ) ) {
    $font_display_property = $global_settings['font_display_property'];
}
...
<div class="wrap rmp-container rmp-setting-page">
    ...
    <form method="post" enctype="multipart/form-data" id="rmp-global-settings">
        ...
        <div id="rmp-setting-tabs">
            <ul class="nav-tab-wrapper rmp-nav-tab-wrapper">
            ...
            <div id="rmp-settings-general" class="rmp-setting-tabs">
            ...
            <div id="rmp-settings-advanced" class="rmp-setting-tabs" style="display:none">
                <table class="form-table" role="presentation">
                    <tbody>
                        <tr>
                            <th scope="row"> <?php esc_html_e( 'Activate Dark Mode', 'responsive-menu-pro'); ?></th>
                            <td>
                                <fieldset>
                                    <p>
                        ...
                        <tr>
                            <th scope="row"> <?php esc_html_e( 'Font display', 'responsive-menu-pro'); ?></th>
                            <td>
                                <label>
                                    <p>
                                        <select name="font_display_property" value="on" id="font_display_property-wp-admin-bar">
                                            <option value="auto" <?php echo ( $font_display_property == 'auto' ? 'selected' : '' ); ?>><?php esc_attr_e( 'auto', 'responsive-menu-pro'); ?></option>
                                            <option value="block" <?php echo ( $font_display_property == 'block' ? 'selected' : '' ); ?>><?php esc_attr_e( 'block', 'responsive-menu-pro'); ?></option>
                                            <option value="swap" <?php echo ( $font_display_property == 'swap' ? 'selected' : '' ); ?>><?php esc_attr_e( 'swap', 'responsive-menu-pro'); ?></option>
                                            <option value="fallback" <?php echo ( $font_display_property == 'fallback' ? 'selected' : '' ); ?>><?php esc_attr_e( 'fallback', 'responsive-menu-pro'); ?></option>
                                            <option value="optional" <?php echo ( $font_display_property == 'optional' ? 'selected' : '' ); ?>><?php esc_attr_e( 'optional', 'responsive-menu-pro'); ?></option>
                                        </select>
                                    </p>
                                    <small>
                                        <i>
                                            <?php esc_html_e( 'Applicable for material icons only', 'responsive-menu-pro'); ?>
                                        </i>
                                    </small>
                                </label>
                            </td>
            ...
            <div id="rmp-settings-style" class="rmp-setting-tabs" style="display:none">
                <table class="form-table" role="presentation">
                    <tbody>
                        <tr>
            ...
            <div id="rmp-settings-import-and-export" class="rmp-setting-tabs" style="display:none">
                <table class="form-table" role="presentation">
                    <tbody>
                        <tr>
