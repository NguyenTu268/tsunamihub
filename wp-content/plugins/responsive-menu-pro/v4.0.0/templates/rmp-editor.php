	...
	<body class="wp-admin wp-core-ui js post-php post-type-rmp_menu <?php echo implode( ' ', $body_classes ); ?>">
		<div id="rmp-editor-wrapper" class="rmp-editor-overlay expanded rmp-preview-mobile">
			<form method="post" enctype="multipart/form-data" id="rmp-editor-form" class="rmp-editor-sidebar">
				...
				<input type="hidden" name="rmp_any_changes" id="rmp_any_changes" value="0"/>
				<?php
				...
				if ( defined( 'ICL_LANGUAGE_CODE' ) ) {
					...
					foreach ( $languages as $language => $value ) {
						$language.'='.$value['url'];
						$current_language_menu_id = apply_filters( 'wpml_object_id', $current_wp_menu->term_id, 'nav_menu', false, $language );
						if ( $current_language_menu_id === $current_wp_menu->term_id ) {
							$home_url = $value['url'];
							break;
						}
					}
						...
						<ul class="rmp-accordion-container" id="rmp-header-ordering-items">
							...
							<?php
								...
								echo $control_manager->add_group_text_control( [
									...
									'type'          => 'text',
									'class'         => 'rmp-menu-header-bar-padding',
									'name'          => 'menu[header_bar_padding]',
									'input_options' => [ 'top', 'right', 'bottom', 'left' ],
									'value_options' => ! empty( $options['header_bar_padding'] ) ? $options['header_bar_padding'] : '',
								] );
									...
									[
										...
										[
											0 => [
												...
												'item_target' => 'header-bar-item-solid-background',
												'item_text' => __('Solid Color ','responsive-menu-pro'),
											],
											1 => [
												'item_class' => 'header-bar-gradient-background-nav-tab',
												'item_target' => 'header-bar-item-gradient-background',
												'item_text' => __('Gradient','responsive-menu-pro'),
											],
										],
									]
								);
								...
								echo $ui_manager->start_tab_item(
									[
										'item_id'    => 'header-bar-item-solid-background',
								...
								echo $ui_manager->start_tab_item(
									[
										'item_id'    => 'header-bar-item-gradient-background',
										'item_class' => 'title-contents',
									]
								);

								echo $control_manager->add_switcher_control( [
									'label'      => __('Use gradient color','responsive-menu-pro'),
									'id'         => 'rmp-header-bar-gradient-color-on',
									'tool_tip'   => [
										'text' => __('Enable gradient color','responsive-menu-pro'),
									],
									'name'       => 'menu[header_bar_gradient_background_colour_on]',
									'is_checked' => is_rmp_option_checked('on', $options,'header_bar_gradient_background_colour_on'),
								] );

								echo $control_manager->add_gradient_color_control( [
									'label' => __('Gradient Colors','responsive-menu-pro'),
									'id'    => 'rmp-header-bar-background-gradient-color',
									'name'  => 'menu[header_bar_gradient_background_%type%]',
									'value' => 'header_bar_gradient_background_%type%',
								...
								echo $control_manager->add_switcher_control( [
									'label'      => __('Enable scrolling color','responsive-menu-pro'),
									'id'         => 'rmp-menu-header-bar-active-scroll',
									'class'      => 'rmp-menu-header-bar-active-scroll',
									'tool_tip'   => [
										'text' => __('Enable to change the header bar background on scrolling.','responsive-menu-pro'),
									],
									'name'       => 'menu[header_bar_scroll_enable]',
									'is_checked' => is_rmp_option_checked('on', $options,'header_bar_scroll_enable'),
								] );

								echo $control_manager->add_color_control( [
									'label'       => __('Color','responsive-menu-pro'),
									'id'          => 'rmp-menu-header-scroll-background-color',
									'name'        => 'menu[header_bar_scroll_background_color]',
									'aria_depend' => 'rmp-menu-header-bar-active-scroll',
									'value'       => rmp_get_value($options,'header_bar_scroll_background_color'),
								] );
						...
						<ul class="rmp-accordion-container">
							<?php
								...
								echo $control_manager->add_text_input_control( [
									...
									'type'        => 'number',
									'aria_depend' => 'rmp-menu-smooth-scroll-on',
					...
					<div id="tab-desktop-menu" class="rmp-accordions" aria-label="Desktop Menu">
						<ul class="rmp-accordion-container">
							<?php
								...
								echo $ui_manager->start_group_controls();
								echo $control_manager->add_select_control( [
									'label'    => __('Menu Side','responsive-menu-pro'),
									...
									'tool_tip' => [
										'text' => __( 'Desktop menu side will not work if menu inside header bar.', 'responsive-menu-pro' ),
									],
								] );

								echo $control_manager->add_select_control( [
									'label'    => __('Alignment','responsive-menu-pro'),
									'class'    => 'rmp-menu-desktop-menu-alignment',
									'id'       => 'rmp-menu-desktop-menu-alignment',
									'name'     => 'menu[desktop_menu_content_alignment]',
									'options'  => [
										'left'   => 'Left',
										'center' => 'Center',
										'right'  => 'Right',
									],
									'value'    => rmp_get_value($options,'desktop_menu_content_alignment'),
									'tool_tip' => [
										'text' => __( 'Desktop content alignment will not work if menu inside header bar.', 'responsive-menu-pro' ),
									],
								] );
								echo $ui_manager->end_group_controls();
								...
								echo $control_manager->add_switcher_control( [
									...
									'group_classes' => 'rmp-menu-current-theme-location-group',
									'id'            => 'rmp-menu-current-theme-location',
									'class'         => 'rmp-menu-current-theme-location',
									'tool_tip'      => [
										'text' => empty(  $global_settings['rmp_wp_footer_hook'] ) ? __('If enabled, the menu will show up at theme location assigned to WordPress menu.','responsive-menu-pro') : __('This option is disabled becouse you are using wp_footer hook','responsive-menu-pro'),
									],
									'name'          => 'menu[use_current_theme_location]',
									'is_checked'    => ! empty(  $global_settings['rmp_wp_footer_hook'] ) ?: is_rmp_option_checked('on', $options,'use_current_theme_location'),
									'is_disabled'   => is_rmp_option_disabled('on', $global_settings,'rmp_wp_footer_hook'),
								] );
								...
								echo $ui_manager->start_accordion_item( [
									'item_header' => [
										'item_title' => __('Background Settings','responsive-menu-pro'),
									],
								] );
								...
								echo $ui_manager->start_tabs_controls_panel(
									[
										...
										[
											0 => [
												'item_class' => 'nav-tab-active',
												'item_target' => 'menu-item-desktop-solid-background',
												'item_text' => __('Solid Color ','responsive-menu-pro'),
											],
											1 => [
												'item_class' => 'desktop-gradient-background-nav-tab',
												'item_target' => 'menu-item-desktop-gradient-background',
												'item_text' => __('Gradient','responsive-menu-pro'),
											],
										],
									]
								...
								echo $ui_manager->start_tab_item(
									[
										'item_id'    => 'menu-item-desktop-solid-background',
										'item_class' => 'title-contents',
									]
								);
								...
								echo $control_manager->add_color_control( [
									'label'    => __('Background Color','responsive-menu-pro'),
									'id'       => 'rmp-desktop-menu-background-color',
									'name'     => 'menu[desktop_menu_container_background_colour]',
									'value'    => rmp_get_value($options,'desktop_menu_container_background_colour'),
									'tool_tip' => [
										'text' => __( 'This colour code will overwrite the mobile menu background color.', 'responsive-menu-pro' ),
									],
								] );
								...
								echo $ui_manager->start_tab_item(
									[
										'item_id'    => 'menu-item-desktop-gradient-background',
										'item_class' => 'title-contents',
									]
								);
								...
								echo $control_manager->add_switcher_control( [
									'label'      => __('Use gradient color','responsive-menu-pro'),
									'id'         => 'rmp-desktop-menu-gradient-color-on',
									'tool_tip'   => [
										'text' => __('Enable gradient color','responsive-menu-pro'),
									],
									'name'       => 'menu[desktop_menu_container_gradient_background_colour_on]',
									'is_checked' => is_rmp_option_checked('on', $options,'desktop_menu_container_gradient_background_colour_on'),
								] );

								echo $control_manager->add_gradient_color_control( [
									'label'    => __('Gradient Colors','responsive-menu-pro'),
									'id'       => 'rmp-desktop-menu-background-gradient-color',
									'name'     => 'menu[desktop_menu_container_gradient_background_%type%]',
									'value'    => 'desktop_menu_container_gradient_background_%type%',
									'tool_tip' => [
										'text' => __( 'This colour code will overwrite the mobile menu background color.', 'responsive-menu-pro' ),
									],
								] );
								...
								echo $ui_manager->start_accordion_item( [
									'item_header'  => [
										...
										'title_class' => 'rmp-mega-menu-accordion-header',
									],
									'item_content' => [
								...
								echo $control_manager->get_mega_menu_top_items( $options );
								...
								echo $control_manager->add_select_control( [
									...
									'id'      => 'rmp-desktop-menu-animation-speed',
						...
						<ul class="rmp-accordion-container">
							<?php
								...
								foreach ( $menus as $menu ) {
									$wp_menu_list[ $menu->term_id ] = $menu->name;
								}
								echo $control_manager->add_select_control( [
								...
								$mobile_menu = wp_get_nav_menu_object(rmp_get_value( $options, 'menu_to_use_in_mobile' ));
								echo $control_manager->add_select_control( [
									'label'       => __('Mobile & Tablet Menu','responsive-menu-pro'),
									'id'          => 'rmp-menu-to-use-in-mobile',
									'aria_depend' => 'rmp-menu-different-menu-for-mobile',
									'name'        => 'menu[menu_to_use_in_mobile]',
									'options'     => $wp_menu_list,
									'value'       => isset( $mobile_menu->term_id ) ? $mobile_menu->term_id : 0,
								] );
								...
								echo $control_manager->add_select_control( [
									...
									'options' => [
										...
										'parent-and-children' => __( 'Parent & child pages ', 'responsive-menu-pro' ),
								...
								$selected_pages = rmp_get_value( $options, 'menu_show_on_pages' );
								if ( is_array($selected_pages) ) {
									foreach ( $selected_pages as $post_id ) {
										$page_list[ $post_id ] = get_the_title($post_id);
									}
								}
								...
								echo $control_manager->add_select_control( [
									'label'   => __('Display condition by users','responsive-menu-pro'),
									'id'      => 'rmp-menu-display-condition-by-users',
									'name'    => 'menu[menu_display_by_users]',
									'options' => [
										'all-users'       => __( 'Show all users', 'responsive-menu-pro' ),
										'logged-in-users' => __( 'Only logged in users', 'responsive-menu-pro' ),
										'guest-users'     => __( 'Only guest users', 'responsive-menu-pro' ),
									],
									'value'   => rmp_get_value( $options, 'menu_display_by_users' ),
								] );
					...
					<div id="tab-menu-styling" class="rmp-accordions" aria-label="Menu Styling">
						<ul class="rmp-accordion-container">
							...
							echo $ui_manager->start_accordion_item( [
								...
								echo $control_manager->add_color_control( [
									'label'    => __('Parent Menu Active','responsive-menu-pro'),
									'id'       => 'rmp-menu-parent-link-active-color',
									'name'     => 'menu[menu_parent_link_active_color]',
									'value'    => rmp_get_value($options,'menu_parent_link_active_color'),
									'tool_tip' => [
										'text' => __('Set the parent menu text color if submenu dropdown is open', 'responsive-menu-pro'),
									],
								] );
								...
								echo $control_manager->add_color_control( [
									'label'    => __('Parent Menu Background Active','responsive-menu-pro'),
									'id'       => 'rmp-menu-parent-link-background-active-color',
									'name'     => 'menu[menu_parent_link_background_active_color]',
									'value'    => rmp_get_value($options,'menu_parent_link_background_active_color'),
									'tool_tip' => [
										'text' => __('Set the parent menu background color if submenu dropdown is open', 'responsive-menu-pro'),
									],
								] );
							...
							echo $control_manager->add_text_input_control( [
								...
								'has_unit' => [
									...
									'classes'   => 'is-unit no-updates no-updates',
							...
							echo $control_manager->add_select_control( [
								...
								'aria_depend' => 'rmp-menu-fade-submenus',
								'options'     => array(
									'right' => 'Right',
									'left'  => 'Left',
								),
							...
							echo $control_manager->add_text_input_control( [
								...
								'type'        => 'text',
								'aria_depend' => 'rmp-menu-use-slide-effect',
					...
					<div id="tab-toggle-button" class="rmp-accordions" aria-label="Toggle Button">
						<ul class="rmp-accordion-container">
							<?php
								...
								echo  $ui_manager->start_group_controls();
								echo $control_manager->add_color_control( [
									'label' => __('Icon Color','responsive-menu-pro'),
								...
								echo $control_manager->add_color_control( [
									'label' => __('Icon Hover','responsive-menu-pro'),
								...
								echo $control_manager->add_color_control( [
									'label' => __('Icon Active','responsive-menu-pro'),
					...
					<div id="tab-container" class="rmp-accordions" aria-label="Container">
						...
						<ul class="rmp-accordion-container" id="rmp-menu-ordering-items">
							...
							<?php
								...
								echo $ui_manager->start_tabs_controls_panel(
									[
										...
										[
											0 => [
												'item_class' => 'nav-tab-active',
												'item_target' => 'menu-item-solid-background',
												'item_text' => __('Solid Color ','responsive-menu-pro'),
											],
											1 => [
												'item_class' => 'menu-gradient-background-nav-tab',
												'item_target' => 'menu-item-gradient-background',
												'item_text' => __('Gradient','responsive-menu-pro'),
											],
										],
									]
								...
								echo $ui_manager->start_tab_item(
									[
										'item_id'    => 'menu-item-solid-background',
										'item_class' => 'title-contents',
									]
								);
								...
								echo $ui_manager->start_tab_item(
									[
										'item_id'    => 'menu-item-gradient-background',
										'item_class' => 'title-contents',
									]
								);
								...
								echo $control_manager->add_switcher_control( [
									'label'      => __('Use gradient color','responsive-menu-pro'),
									'id'         => 'rmp-menu-gradient-color-on',
									'tool_tip'   => [
										'text' => __('Enable gradient color','responsive-menu-pro'),
									],
									'name'       => 'menu[menu_container_gradient_background_colour_on]',
									'is_checked' => is_rmp_option_checked('on', $options,'menu_container_gradient_background_colour_on'),
								] );

								echo $control_manager->add_gradient_color_control( [
									'label' => __('Gradient Colors','responsive-menu-pro'),
									'id'    => 'rmp-menu-background-gradient-color',
									'name'  => 'menu[menu_container_gradient_background_%type%]',
									'value' => 'menu_container_gradient_background_%type%',
			...
			<main id="rmp-editor-preview" class="rmp-editor-preview-main">
				<div id="rmp-preview-wrapper" class="rmp-preview-wrapper">
					...
					<?php
					if ( strpos($home_url, '?') ) {
						$home_url = $home_url .'&rmp_preview_mode=true&menu_id='.get_the_ID();
					}else {
						$home_url = $home_url .'?rmp_preview_mode=true&menu_id='.get_the_ID();
					}
					?>
					<iframe id="rmp-preview-iframe" src="<?php echo esc_url( $home_url );  ?>"></iframe>
				</div>
			</main>
			<?php echo $editor->sidebar_drawer(); ?>
		</div>
		<?php
			include_once RMP_PLUGIN_PATH_V4 . '/templates/wizards.php';
