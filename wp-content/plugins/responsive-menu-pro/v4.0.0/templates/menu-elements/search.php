...
<li class="rmp-accordion-item rmp-order-item">
    ...
    <div class="rmp-accordion-content tabs rmp-menu-controls">
        ...
        <div id="search-contents" class="title">
            ...
            <div class="rmp-input-control-wrapper full-size">
                <label class="rmp-input-control-label"> <?php esc_html_e('Custom search code', 'responsive-menu-pro'); ?> </label>
                <div class="rmp-input-control">
					<textarea placeholder="<?php esc_html_e( 'Add your custome search code..', 'responsive-menu' ); ?>" id="rmp-menu-search-box-code" name="menu[menu_search_box_code]" class="regular-text"><?php echo esc_attr( rmp_get_value( $options, 'menu_search_box_code' ) ); ?></textarea>
                </div>
            </div>
        </div>
