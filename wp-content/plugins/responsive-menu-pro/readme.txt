...
* Feature: Added support for placing action/social icons inside the menu container (e.g., call, email, WhatsApp, social links).

= 4.6.0 (23rd July 2025) =
* Feature: Added option to hide menu items for logged in and non logged in users

= 4.5.1 (21st April 2025) =
* Bug: Fixed JS error with mega menu columns
...
= 4.3.2 (27th Dec 2023) =
* Feature: Added option to highlight active parent menus
* Bug: Fixed issue with desktop submenu background color options
* Bug: Fixed issue with disable background scrolling option
...
* Feature: The option to hide or show specific menu items has been added
...
* Bug: Fixed PHP warning issues with mega menu
* Enhancement: Added alert popup if WordPress Menus are empty

= 4.1.12 (1st Aug 2022) =
* Feature: Added multiple device option for menu container width
...
* Enhancement: Improved mega menu widget layout

= 4.1.11 (25th May 2022) =
* Bug: Fixed issue with desktop breakpoint
...
* Bug: Fixed issue with submenu font-weight
* Bug: Fixed multiple issues with mega menus
* Bug: Fixed performance issues when a website has several posts/pages
* Feature: Added options for changing text color inside mega menu columns
...
* Others: Skipping versions to sync with latest free version number
...
= 4.1.5 (17th Sep 2021) =
* Bug: Fixed integration issue with WPML.
* Bug: Fixed "Hide Theme Menu" option to hide menu only for active breakpoints
* Bug: Fixed transparent background issue.
* Feature: Added option for showing different menus for logged in users and guest users under general settings.
* Feature: Added additional display condition as "Parent and child pages" under general settings.
...
* Feature: Added warning message if theme location is not set for selected menu.
...
= 4.1.4 (23rd Aug 2021) =
* Bug: Fixed responsive menu CSS loading on each page despite include only pages condition.
* Bug: Fixed update notification issue with theme location enabled.
* Feature: Update desktop theme location option to be disabled automatically if the wp_footer hook is enabled.
* Feature: Added font-display property for material icons.
* Feature: Added different background colors for the mobile menu and the desktop menu.
* Feature: Added gradient background option for the mobile menu, desktop menu and header bar.
* Enhancement: Updated accent color in dark mode
...
* Bug: Fixed the issue where changes made on WordPress menu are not reflected in the mega menu
